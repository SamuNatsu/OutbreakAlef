...
public final class Shared {
    // Version
    static public final String version = "v1.0.1";
    ...
    // Animate
    static public final Animate titleA = new Animate(Shared.titleS, Vec2.getInstance(), Vec2.getInstance(640, 256), 2);
    // Color
    ...
    static public boolean enableNetwork = false, isSvr = false, netDiscon = false;
    ...
    static public void init() {
        ...
        titleA.loop = true;
        titleA.rect.position = Application.size.div(-2).add(160, 100);
        // Make mobS
